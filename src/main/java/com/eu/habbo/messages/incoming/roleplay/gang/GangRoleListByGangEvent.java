...
import com.eu.habbo.messages.outgoing.roleplay.gang.GangRoleListByGangComposer;

public class GangRoleListByGangEvent extends MessageHandler {
    @Override
    public void handle() throws Exception {
        ...
        this.client.sendResponse(new GangRoleListByGangComposer(gang));
    }
}
